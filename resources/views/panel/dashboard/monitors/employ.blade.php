...
<br><br>
                <div style="display: flex; flex-direction: column; gap: 20px; width: 50%; margin: inherit;">
                    ...
                    <form method="get" action="{{ route('monitors.employ') }}" style="display: flex; flex-direction: column; gap: 10px;">
                    ...
                    <form action="{{Route('monitors.set.employ')}}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{$monitor->id}}">
                        ...
                        <button type="button" class="btn" style="background-color: gainsboro;color: black; padding: 7.0px 20px;" onclick="window.location.href='{{ route('monitors.show') }}';">الغاء</button>
                    </form>
                </div>
            </div>
