                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-lg rounded-lg" style="border: none;">
                            <div class="card-body">
                                <h5 class="card-title" style="font-family: 'Cairo', sans-serif; color: #002238;">المدن </h5>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-lg rounded-lg" style="border: none;">
                            <div class="card-body">
                                <h5 class="card-title" style="font-family: 'Cairo', sans-serif; color: #330500;">العملاء</h5>
                    ...
                    <div class="col-md-4" ">
                        <div class="card shadow-lg rounded-lg" style="border: none;background-color: #ffffff">
                            <div class="card-body">
                                <h5 class="card-title" style="font-family: 'Cairo', sans-serif; color: #002907;">المشرفين </h5>
