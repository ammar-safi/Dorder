                ...
                <div class="col-12"> 
                    <form action="{{ route('admins.store') }}" method="POST"> 
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            <div class="password-input">
                              <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="تأكيد كلمة المرور" value="{{old('password_confirmation')?old('password_confirmation'):$admin}}">
