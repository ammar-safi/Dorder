            ...
            <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
                ...
                <form method="GET" action="{{ route('areas.show') }}" style="margin-bottom: 10px; display: flex; align-items: center; gap: 10px;">
                    ...
                    <div style="position: relative; display: flex; align-items: center; width: 200px;">
                        <input type="text" class="custom-select" name="search_name" id="search_name" value="{{ $searchName }}" placeholder="اسم المنطقة" style="padding: 5px 40px 5px 10px; width: 100%; font-size: 0.875rem; border-radius: 5px; border: 1px solid #ccc;">
